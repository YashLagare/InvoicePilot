                        ...
                        <tr>
                            <td style="padding: 40px 40px 20px 40px;">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #f4f4f5; border-radius: 8px; padding: 24px; margin-bottom: 32px;">
                                    <tr>
                                        <td style="padding-bottom: 12px; font-size: 14px; color: #71717a;">Amount Due</td>
                                        <td align="right" style="padding-bottom: 12px; font-size: 24px; font-weight: 600; color: #09090b;">${data.currency} ${data.total}</td>
                                    </tr>
                                    <tr>
