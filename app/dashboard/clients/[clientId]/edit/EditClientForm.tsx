...
import { editClientAction } from "@/app/action";
            ...
            <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        Update client contact details and address information.
                    </p>
                </div>
            </div>
            ...
            <Card className="rounded-2xl border-slate-200 dark:border-slate-800 shadow-sm">
                <CardHeader>
                    <CardTitle className="text-lg flex items-center gap-2">
                        <UserCheck className="w-5 h-5 text-blue-600" /> Client Profile Settings
                    </CardTitle>
                    <CardDescription>
                        Changes made here will apply to future invoices created for this client.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form id={form.id} onSubmit={form.onSubmit} action={action} className="space-y-5">
                        ...
                        <div className="pt-4 flex gap-3">
                            ...
                            <div className="w-2/3">
                                <SubmitButton text="Update Client Profile" />
                            </div>
                        </div>
                    </form>
                </CardContent>
